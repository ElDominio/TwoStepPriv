 ...
 */
    ...
    Serial.print("Toyota output inverted:");Serial.println(bitRead(bitField, BIT_TOYOTA_FAKE));
    /*char tempCyl = 0;
    ...
    Serial.print("RPM Filter inverted: ");Serial.println(bitRead(bitField, BIT_RPM_FILTER));
  }
